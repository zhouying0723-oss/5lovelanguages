...
export default function Home() {
  ...
  const restart = () => { setAnswers(Array(30).fill(0)); setIndex(0); setTieGroupIndex(0); setTieOpponentIndex(1); setTieChampion(null); setTieChoices({ receive: [], give: [] }); setTieWinners({}); setPhase("quiz"); setPosterOpen(false); };
